...
GITHUB_TOKEN = ""  # GITHUB TOKEN DENGAN AKSES REPO
REPO_NAME = "" # NAMA REPO DALAM FORMAT "USERNAME/REPO"
BRANCH = "" # NAMA CABANG (BRANCH) TEMPAT FILE AKAN DIUPLOAD, MISAL "main" ATAU "master"
